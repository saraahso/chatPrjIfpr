...
import br.edu.ifpr.api.resource.MensagemDTO;
...
public class WebSocketService {
	...
	public WebSocketService(SimpMessagingTemplate simpMessagingTemplate, 
			...
			@Value("${chatPrjIfpr.websocket.chat}") String websocketChat,
			@Value("${chatPrjIfpr.websocket.online-users}") String websocketOnlineUsers) {
